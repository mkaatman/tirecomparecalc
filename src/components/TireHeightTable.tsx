...
export default function TireHeightTable({min, max, onSelect, tires}: {min: TireDataForm, max: TireDataForm, onSelect: React.Dispatch<React.SetStateAction<tire[]>>, tires: tire[]}) {
