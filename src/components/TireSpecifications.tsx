...
import {calculateTireHeight, calculateCircumference, calculateRevs, calculateSideWallHeight} from '../../util/helpers';
import Card from "../ui/Card";
import DisplayTire from "./DisplayTire";

// Sub-display of specifications per tire
export default function TireSpecifications({tire, index}: {tire: tire, index: number}) {
